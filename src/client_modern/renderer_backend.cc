...
void renderer::backend::init(void)
{
...
void renderer::backend::init_late(void)
{
    // empty
}

void renderer::backend::shutdown(void)
{
...
void renderer::backend::prepare(void)
{
...
void renderer::backend::present(void)
{
...
SDL_WindowFlags renderer::backend::window_flags(void)
{
